...
internal static class PipeCommandNames
{
    private static readonly Dictionary<string, string[]> PreferredAliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Tools.IdeSaveDocument"] = new[] { "save-document" },
        ...
        ["Tools.IdeDebugThreads"] = new[] { "debug-threads" },
        ["Tools.IdeDebugStack"] = new[] { "debug-stack" },
        ["Tools.IdeDebugLocals"] = new[] { "debug-locals" },
        ["Tools.IdeDebugModules"] = new[] { "debug-modules" },
        ["Tools.IdeDebugWatch"] = new[] { "debug-watch" },
        ["Tools.IdeDebugExceptions"] = new[] { "debug-exceptions" },
        ["Tools.IdeDiagnosticsSnapshot"] = new[] { "diagnostics-snapshot" },
        ["Tools.IdeBuildConfigurations"] = new[] { "build-configurations" },
        ["Tools.IdeSetBuildConfiguration"] = new[] { "set-build-configuration" },
        ["Tools.IdeCountReferences"] = new[] { "count-references" },
